...
from .views import UserCreate, ChatView, LoadPreviousChatView, UserSettingsView, ChatSessionView, DocumentSearchView
...
urlpatterns = [
    ...
    path('search/', DocumentSearchView.as_view(), name='document_search'),  # Document search endpoint
]
